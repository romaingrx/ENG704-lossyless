...
@last modified : 2022 Mar 17, 11:10:52
"""
...
stl10_train = dataset(DATA_DIR, download=True, split="train", transform=transform)
stl10_test = dataset(DATA_DIR, download=True, split="test", transform=transform)
